<%@ Page Title="Zone Master" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="MasterZone.aspx.cs" Inherits="MasterZone" %>
                ...
                <div class="widget-body">
                    <table class="commontable">
                        ...
                        <tr>
                            ...
                            <td width="200px">
                                <asp:TextBox runat="server" ID="txtzonecode" class="txtbox bgcolrblue" TabIndex="1"
                                    Width="80px" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtzonecode"
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtzonename" class="txtbox bgcolrblue" TabIndex="2" />
