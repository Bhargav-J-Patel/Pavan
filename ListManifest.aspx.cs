...
using App_Code;
using System.Data;
public partial class ListManifest : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //ds = cn.RunSql("sp_listManifest 'L','" + Request.Cookies["branchid"].Value + "','',''", "select");
            //GvManifestList.DataSource = ds;
    ...
    //protected void GvManifestList_PageIndexChanging(object sender, GridViewPageEventArgs e)
    //{
    //    try
    //    {
    //        GvManifestList.PageIndex = e.NewPageIndex;
    //        ds = cn.RunSql("sp_listManifest 'L','" + Request.Cookies["branchid"].Value + "','',''", "select");
    //        GvManifestList.DataSource = ds;
    //        GvManifestList.DataBind();
    //    }
