    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Request.QueryString["id"] != null)
            {
                ...
                {
                    ds = cn.RunSql("sp_addcustomer 'U','" + txtcuscode.Text + "','" + txtcusname.Text + "','" + txtaddress.Text + "','" + HifLocation.Value + "','" + TxPhNo.Text + "','" + txtmobile.Text + "','" + txtemailid.Text + "','" + txtdob.Text + "','" + ddlpaymenttype.SelectedValue + "','" + charge + "','" + HifContract.Value + "','0','" + Request.Cookies["compid"].Value + "','" + Request.Cookies["loginid"].Value + "','" + Request.Cookies["branchid"].Value + "','" + Request.QueryString["id"] + "'", "insert");
                    Session["Msg"] = "You have sucessfully Update Customer !!";
                    Response.Redirect("ListCustomer.aspx");
                }
                if (Request.QueryString["D"] == "1")
                {
                    if (ddldelete.SelectedValue == "Yes")
                    {
                        ...
                        Session["Msg"] = "You have sucessfully Delete Customer !!";
                        Response.Redirect("ListCustomer.aspx");
                    }
                }
            }
            ...
            {
                ds = cn.RunSql("sp_addcustomer 'I','" + txtcuscode.Text + "','" + txtcusname.Text + "','" + txtaddress.Text + "','" + HifLocation.Value + "','" + TxPhNo.Text + "','" + txtmobile.Text + "','" + txtemailid.Text + "','" + txtdob.Text + "','" + ddlpaymenttype.SelectedValue + "','" + charge + "','" + HifContract.Value + "','0','" + Request.Cookies["compid"].Value + "','" + Request.Cookies["loginid"].Value + "','" + Request.Cookies["branchid"].Value + "',''", "insert");
