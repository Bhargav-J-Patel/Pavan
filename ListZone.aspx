<%@ Page Title="Zone List" Language="C#" MasterPageFile="~/PavanCourier.master" AutoEventWireup="true"
    CodeFile="ListZone.aspx.cs" Inherits="ListZone" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListZone',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.zone.substr(1, 1) != "1") {
                        oTable.column(3).visible(false);
                    }
                    if (data.d.zone.substr(2, 1) != "1") {
            ...
            <div class="widget-body">
                <asp:GridView ID="GvZoneList" runat="server" AutoGenerateColumns="false" PageSize="50"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Zone Code" DataField="cZoneCode" />
                        <asp:BoundField HeaderText="Zone Name" DataField="cZoneName" />
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","MasterZone.aspx?id={0}&E=1") %>'>
                        ...
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","MasterZone.aspx?id={0}&D=1") %>'>
