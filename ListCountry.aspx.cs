...
public partial class ListCountry : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            //ds = cn.RunSql("sp_listcountry 'L','" + Request.Cookies["compid"].Value + "',''", "select");
    ...
    //        ds = cn.RunSql("sp_listcountry 'L','" + Request.Cookies["branchid"].Value + "',''", "select");
    //        GvZoneList.DataSource = ds;
    //        GvZoneList.DataBind();
    //    }
    //    catch (Exception ex)
