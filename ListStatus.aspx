<%@ Page Title="Status List" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="ListStatus.aspx.cs" Inherits="ListStatus" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListStatus',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.exception.substr(1, 1) != "1") {
                        oTable.column(3).visible(false);
                    }
                    if (data.d.exception.substr(2, 1) != "1") {
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-11">
            <div class="widget-box">
                ...
                <div class="widget-body">
                    <asp:GridView ID="GvStatusList" runat="server" AutoGenerateColumns="false" 
                        PageSize="50" AllowPaging="true" OnPageIndexChanging="GvStatusList_PageIndexChanging"
                        class="table table-striped table-bordered table-hover">
                        <Columns>
                            <asp:BoundField DataField="NID" Visible="false" />
                            <asp:BoundField HeaderText="Sr No" DataField="nsrno" />
                            <asp:BoundField HeaderText="Status Code" DataField="cStatusCode" />
                            <asp:BoundField HeaderText="Status Name" DataField="cStatusDetail" />
                            <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                                <ItemTemplate>
                                    <a href='<%#Eval("NID","MasterStatus.aspx?id={0}&E=1") %>'>
                            ...
                            <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                                <ItemTemplate>
                                    <a href='<%#Eval("NID","MasterStatus.aspx?id={0}&D=1") %>'>
