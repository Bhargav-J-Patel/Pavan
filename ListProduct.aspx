<%@ Page Title="Product List" Language="C#" MasterPageFile="~/PavanCourier.master" AutoEventWireup="true" CodeFile="ListProduct.aspx.cs" Inherits="ListProduct" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListProduct',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.product.substr(1, 1) != "1") {
                        oTable.column(3).visible(false);
                    }
                    if (data.d.product.substr(2, 1) != "1") {
...
<div class="row">
    <div class="col-xs-12 col-sm-11">
		<div class="widget-box">
			<div class="widget-header">
            <div style="float:left">
                <h4 class="widget-title">List Product Master</h4>
            </div>
			<div style="float:right;">
                <asp:Button ID="btnaddnew" Text="Add New" runat="server" class="btn btn-primary" 
                    style="margin-top:4px;margin-right:3px;" onclick="btnaddnew_Click"/>
			...
			<div class="widget-body">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField HeaderText="Product Code" DataField="cProductCode" />
                        <asp:BoundField HeaderText="Product Name" DataField="cProductName" />
                     
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","MasterProduct.aspx?id={0}&E=1") %>'>
                        ...
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","MasterProduct.aspx?id={0}&D=1") %>'>
