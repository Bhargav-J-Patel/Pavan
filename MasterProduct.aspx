<%@ Page Title="Product Master" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="MasterProduct.aspx.cs" Inherits="MasterProduct" %>
                ...
                <div class="widget-body">
                    <table class="commontable">
                        ...
                        <tr>
                            ...
                            <td width="200px">
                                <asp:TextBox runat="server" ID="txtproductcode" class="txtbox bgcolrblue" TabIndex="1"
                                    Width="80px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtproductname" class="txtbox bgcolrblue" TabIndex="2" />
