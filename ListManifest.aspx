<%@ Page Title="List Manifest" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="ListManifest.aspx.cs" Inherits="ListManifest" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListManifest',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.manifest.substr(1, 1) != "1") {
                        oTable.column(3).visible(false);
                    }
                    if (data.d.manifest.substr(2, 1) != "1") {
                            ...
                            <table id="datatable" width="100%" class="table table-responsive table-bordered table-hover"
                                ...
                                <thead>
                                    <tr style="background-color: #2A3F54; color: #fff; height: 34px;">
                                        ...
                                        <th style="width: 10px; padding: 5px 0px 5px 5px;">
                                            &nbsp;
                                        </th>
                                        <th style="width: 10px; padding: 5px 0px 5px 5px;">
                                            &nbsp;
...
<div class="row">
    <div class="col-xs-12 col-sm-11">
		<div class="widget-box">
			<div class="widget-header">
            <div style="float:left">
                <h4 class="widget-title">List Manifest</h4>
            </div>
			<div style="float:right;">
                <asp:Button ID="btnaddnew" Text="Add New" runat="server" class="btn btn-primary" 
                    style="margin-top:4px;margin-right:3px;" onclick="btnaddnew_Click"/>
			...
			<div class="widget-body">
                    <asp:GridView ID="GvManifestList" runat="server" AutoGenerateColumns="false"  PageSize="50"
                    AllowPaging="true" OnPageIndexChanging="GvManifestList_PageIndexChanging" class="table table-striped table-bordered table-hover">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                         ...
                         <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                                <ItemTemplate>
                                    <a href="Report.aspx?rpt=5&manifest=<%# DataBinder.Eval(Container.DataItem,"nManifestNo")%>">
