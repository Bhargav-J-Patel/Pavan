<%@ Page Title="Vendor Master" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="MasterVendor.aspx.cs" Inherits="MasterVendor" %>
                ...
                <div class="widget-body">
                    <table class="commontable" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TxtPanCardNo" class="txtbox bgcolrblue" TabIndex="8"
                                    Width="200px" />
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtmobile"
                                    ErrorMessage="&lt;img src='assets/img/writing-icon.jpg' title='DELETE' alt='View' border='0'/&gt;"
                                    ValidationGroup="Main"></asp:RequiredFieldValidator>--%>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TxtServiceTaxNo" class="txtbox bgcolrblue" TabIndex="9"
                                    Width="200px" />
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtmobile"
                                    ErrorMessage="&lt;img src='assets/img/writing-icon.jpg' title='DELETE' alt='View' border='0'/&gt;"
                                    ValidationGroup="Main"></asp:RequiredFieldValidator>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtdob" class="txtbox date_picker" TabIndex="10"
                                    Width="150px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlpaymenttype" TabIndex="11" Width="100px"
                                    CssClass="select">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Panel ID="PanelItem" runat="server" Height="100%" ScrollBars="Vertical" Style="overflow-x: hidden;
                                    overflow-y: auto;" TabIndex="12" Width="100%" CssClass="select">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtcontract" class="txtbox bgcolrgreen" TabIndex="13"
                                    Width="200px" />
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <asp:Button ID="Button1" Text="Submit" runat="server" class="btn btn-info" ValidationGroup="Main"
                                    TabIndex="14" OnClick="Button1_Click" />
