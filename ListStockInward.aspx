<%@ Page Title="Stock Inward List" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="ListStockInward.aspx.cs" Inherits="ListStockInward" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListStockInward',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.inward.substr(1, 1) != "1") {
                        oTable.column(5).visible(false);
                    }
                    if (data.d.inward.substr(2, 1) != "1") {
...
<div class="row">
    <div class="col-xs-12 col-sm-11">
		<div class="widget-box">
			<div class="widget-header">
            <div style="float:left">
                <h4 class="widget-title">List Stock Inward</h4>
            </div>
			<div style="float:right;">
                <asp:Button ID="btnaddnew" Text="Add New" runat="server" class="btn btn-primary" 
                    style="margin-top:4px;margin-right:3px;" onclick="btnaddnew_Click"/>
    ...
    <%-- <asp:BoundField HeaderText="Customer Name" DataField="cCustomerName" />
                        <asp:BoundField HeaderText="From AWB No" DataField="nFromAWBNo" />
                        <asp:BoundField HeaderText="To AWB No" DataField="nToAWBNo" />
                        <asp:BoundField HeaderText="Total" DataField="nTotal" />
                     
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","TranStockInward.aspx?id={0}&E=1") %>'>
                        ...
                        <asp:TemplateField HeaderText="..." ItemStyle-Width="5%">
                            <ItemTemplate>
                                <a href='<%#Eval("NID","TranStockInward.aspx?id={0}&D=1") %>'>
