<%@ Page Title="Agent Master" Language="C#" MasterPageFile="~/PavanCourier.master" AutoEventWireup="true" CodeFile="MasterAgent.aspx.cs" Inherits="MasterAgent" %>
            ...
            <div class="widget-box">
                <div class="widget-header">
                    ...
                    <div style="float: right;">
                        <asp:Button ID="btnlist" Text="List" runat="server" class="btn btn-primary" TabIndex="17"
                ...
                <div class="widget-body">
                    <table class="commontable" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TxtContactPerson" class="txtbox bgcolrblue" TabIndex="3"
                                    Width="300px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtaddress" class="bgcolrblue" TextMode="MultiLine"
                                    TabIndex="4" Height="95px" Width="300px" />
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtlocation" class="txtbox bgcolrgreen" TabIndex="5"
                                    Width="200px" />
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtemailid" class="txtbox bgcolrblue" TabIndex="6"
                                    Width="300px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="TxPhNo" class="txtbox bgcolrblue" TabIndex="7" Width="200px" />
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtmobile" class="txtbox bgcolrblue" TabIndex="8"
                                    Width="200px" />
                                <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtmobile"
                                    ErrorMessage="&lt;img src='assets/img/writing-icon.jpg' title='DELETE' alt='View' border='0'/&gt;"
                                    ValidationGroup="Main"></asp:RequiredFieldValidator>--%>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtdob" class="txtbox date_picker" TabIndex="9" Width="150px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList runat="server" ID="ddlpaymenttype" TabIndex="10" Width="100px" CssClass="select">
                         ...
                         <tr>
                            ...
                            <td>
                                <asp:TextBox runat="server" ID="txtcommission" class="txtbox bgcolrred" Style="text-align: right"
                                    onkeypress="return validateKeyPress(event,validNums)" TabIndex="13" />
                            </td>
                            <th>
                                Extra Rate :
                            </th>
                            <td>
                                <asp:TextBox runat="server" ID="TxtExtraRate" class="txtbox bgcolrred" Style="text-align: right"
                                    onkeypress="return validateKeyPress(event,validNums)" TabIndex="14" />
                            </td>
                        </tr>
                        <tr>
                         <th>
                         ...
                         <tr>
                            <td colspan="2">
                                ...
                                <asp:Button ID="Button1" Text="Submit" runat="server" class="btn btn-info" ValidationGroup="Main" Width="110px"
                                    TabIndex="15" OnClick="Button1_Click" />
