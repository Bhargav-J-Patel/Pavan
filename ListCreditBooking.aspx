<%@ Page Title="List Credit Booking" Language="C#" MasterPageFile="~/PavanCourier.master"
    AutoEventWireup="true" CodeFile="ListCreditBooking.aspx.cs" Inherits="ListCreditBooking" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#datatable').DataTable({
                ...
                bServerSide: true,
                sAjaxSource: 'ListPage.asmx/ListCreditBooking',
                sServerMethod: 'post',
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.d.credit.substr(1, 1) != "1") {
                        oTable.column(6).visible(false);
                    }
                    if (data.d.credit.substr(2, 1) != "1") {
